...
<!-- Mirrored from themesbrand.com/steex/layouts/auth-signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Oct 2024 03:16:13 GMT -->
<head>

    <meta charset="utf-8">
    <title>Sign Up | Steex - Admin & Dashboard Template</title>
    ...
    <!-- Layout config Js -->
    <script src="../ssets/js/layout.js"></script>
    <!-- Bootstrap Css -->
                            ...
                            <div class="col-xxl-6 mx-auto">
                                <div class="card mb-0 border-0 shadow-none mb-0">
                                    <div class="card-body p-sm-5 m-lg-4">
                                        ...
                                        <div class="p-2 mt-5">
                                            <form method="post">
                                            <form class="needs-validation" novalidate action="https://themesbrand.com/steex/layouts/index.html" method="post">
                                                <div class="mb-3">
                                                    <label for="username" class="form-label">Username <span class="text-danger">*</span></label>
                                                    <input type="hidden" class="form-control " name="id_user" value="" required>
                                                    <input type="text" class="form-control " id="username" placeholder="Enter username" name="nama">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="position-relative auth-pass-inputgroup">
                                                        <input type="password" class="form-control password-input pe-5" onpaste="return false" placeholder="Enter password" id="password-input" name="password" >
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label" for="password-input">Repeat Password <span class="text-danger">*</span></label>
                                                    <div class="position-relative auth-pass-inputgroup">
                                                        <input type="password" class="form-control password-input pe-5" onpaste="return false" placeholder="Enter password" id="password-input" name="password2">
                                                        <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon" type="button" id="password-addon"><i class="ri-eye-fill align-middle"></i></button>
                                                        <div class="invalid-feedback">
                                                            Please enter password
                                                        </div>
                                                ...
                                                <div class="mt-4">
                                                    <button class="btn btn-primary w-100" type="submit" name="registrasi">Sign Up</button>
                                                </div>
...
<!-- Mirrored from themesbrand.com/steex/layouts/auth-signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Oct 2024 03:16:14 GMT -->
</html>
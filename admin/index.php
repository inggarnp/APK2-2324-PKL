...
/*
kita akan cek apakah sudah login apa belum , jika sudah dia level nya apa maka harus kita arahkan sesuai levelnya 
...
?>
<!doctype html>
<html lang="en" data-layout="vertical" data-sidebar="dark" data-sidebar-size="lg" data-preloader="disable" data-theme="default" data-bs-theme="light">

<!-- Mirrored from steex.php.themesbrand.com/tables-datatables.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Oct 2024 02:33:44 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <meta charset="utf-8">
    <title>Aplikasi Pengelolaan & Penilaian PKL</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Minimal Admin & Dashboard Template" name="description">
    <meta content="Themesbrand" name="author">
    <!-- App favicon -->
    <link rel="shortcut icon" href="../assets/images/logo/logo_smk.png">
...
<body>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box horizontal-logo">
                            <a href="index.html" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="../assets/images/logo/logo.smk.ars.jpeg" alt="" height="22">
                                </span>
                                <span class="logo-lg">
                                    <img src="../assets/images/logo/logo.smk.ars.jpeg" alt="" height="22">
                                </span>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown ms-sm-3 header-item topbar-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="?pages=profil"><i class="mdi mdi-account-circle text-muted fs-lg align-middle me-1"></i> <span class="align-middle">Profile</span></a>
                                ...
                                <a class="dropdown-item" href="../inc/logout.php"><i class="mdi mdi-logout text-muted fs-lg align-middle me-1"></i> <span class="align-middle" data-key="t-logout">Logout</span></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                <a href="index.php" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="../assets/images/logo/logo_smk_bulet.png" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="../assets/images/logo/logo_smk_bulet.png" alt="" height="22">
                    </span>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="?pages=dashboard" class="nav-link menu-link"> <i class="ph-calendar"></i> <span data-key="t-calendar">Dashboard</span> </a>
                        </li>
                    </ul>
                </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link collapsed" href="#sidebarAuth" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAuth">
                        <i class="ph-user-circle"></i> <span data-key="t-authentication">Master</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarAuth">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="?pages=tampil" class="nav-link" role="button" data-key="t-logout"> Tampil </a>
                            </li>
                            <li class="nav-item">
                                <a href="?pages=tambah" class="nav-link" role="button" data-key="t-success-message"> Tambah </a>
                            </li>
                            <li class="nav-item">
                                <a href="?pages=profil" class="nav-link" role="button" data-key="t-two-step-verification"> Profile </a>
                            </li>
                            <li class="nav-item">
                                <a href="?pages=setting" class="nav-link" role="button" data-key="t-two-step-verification"> Setting </a>
                            </li>
                            <li class="nav-item">
                                <a href="?pages=print" class="nav-link" role="button" data-key="t-two-step-verification"> Invoice / Print </a>
                            </li>
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="#sidebarLearning" class="nav-link menu-link  collapsed" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarLearning">
                        <i class="ph-graduation-cap"></i> <span data-key="t-learning">Setting</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarLearning">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="#sidebarCourses" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarCourses" data-key="t-courses"> User </a>
                                <div class="collapse menu-dropdown" id="sidebarCourses">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="?pages=user_admin" class="nav-link" data-key="t-list-view">User Admin</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="?pages=user_penguji" class="nav-link" data-key="t-grid-view">User Penguji</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="?pages=user_pembimbing" class="nav-link" data-key="t-category">User Pembimbing</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="?pages=user_siswa" class="nav-link" data-key="t-overview">Siswa</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item">
                                <a href="#sidebarStudent" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarStudent" data-key="t-students"> Konfigurasi </a>
                                <div class="collapse menu-dropdown" id="sidebarStudent">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="?pages=branch" class="nav-link" data-key="t-my-subscriptions">Branch</a>
                                        </li>
                                        <li class="nav-item">
    ...
    <script src="../assets/js/code.jquery.com/jquery-3.6.0.min.js" integrity="sha256-/xUj+3OJU5yExlq6GSYGSHk7tPXikynS7ogEvDej/m4=" crossorigin="anonymous"></script>
    ...
    <script src="../assets/js/pages/dashboard-real-estate.init.js"></script>

    <!--datatable js-->
    <script src="../assets/js/cdn.datatables.net/1.11.5/js/jquery.dataTables.min.js"></script>
    <script src="../assets/js/cdn.datatables.net/1.11.5/js/dataTables.bootstrap5.min.js"></script>
    <script src="../assets/js/cdn.datatables.net/responsive/2.2.9/js/dataTables.responsive.min.js"></script>
    <script src="../assets/js/cdn.datatables.net/buttons/2.2.2/js/dataTables.buttons.min.js"></script>
    <script src="../assets/js/cdn.datatables.net/buttons/2.2.2/js/buttons.print.min.js"></script>
    <script src="../assets/js/cdn.datatables.net/buttons/2.2.2/js/buttons.html5.min.js"></script>
    <script src="../assets/js/cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.53/vfs_fonts.js"></script>
    <script src="../assets/js/cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.53/pdfmake.min.js"></script>
    <script src="../assets/js/cdnjs.cloudflare.com/ajax/libs/jszip/3.1.3/jszip.min.js"></script>
...
<!-- Mirrored from steex.php.themesbrand.com/tables-datatables.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Oct 2024 02:33:53 GMT -->

        ...
        <div class="card">\
            <div class="card-body">\
                ...
                <div class="text-center mt-4">\
                    <a href="apps-ecommerce-seller-overview.php"><h5>'+ datas[i].shop[0].name + '</h5></a>\
            ...
            <div class="card-body hstack gap-2">\
                <a href="apps-ecommerce-seller-overview.php" class="btn btn-subtle-secondary w-100">View Details</a>\
